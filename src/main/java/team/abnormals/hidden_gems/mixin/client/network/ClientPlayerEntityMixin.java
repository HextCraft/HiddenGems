package team.abnormals.hidden_gems.mixin.client.network;
...
public abstract class ClientPlayerEntityMixin extends AbstractClientPlayerEntity {
    ...
    @Shadow public int field_3921;
    @Shadow protected int field_3935;
    ...
    @Shadow protected abstract boolean method_20623();
    ...
    @Shadow private int field_3934;

    @Shadow protected abstract void pushOutOfBlocks(double double_1, double double_2, double double_3);

    @Shadow public abstract boolean isInWater();

    @Shadow public abstract void setSprinting(boolean boolean_1);

    @Shadow public abstract void sendAbilitiesUpdate();

    @Shadow @Final public ClientPlayNetworkHandler networkHandler;
    @Shadow private boolean field_3939;
    @Shadow private int field_3917;
