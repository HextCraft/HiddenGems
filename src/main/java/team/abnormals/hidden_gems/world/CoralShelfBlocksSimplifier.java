...
public class CoralShelfBlocksSimplifier {
...
//    private BlockState CORAL_SHOWER;
    ...
    public CoralShelfBlocksSimplifier(Block coralBlockBlock, Block coralBlock, Block coralFan, Block coralWallFan/*, Block coralShower*/) {
