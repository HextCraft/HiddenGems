package team.abnormals.hidden_gems.world.carvers;
...
public class CaveCarver extends Carver<ProbabilityConfig> {
   ...
   public CaveCarver(Function<Dynamic<?>, ? extends ProbabilityConfig> function_1, int int_1) {
   ...
   protected void carveCave(Chunk chunk_1, long long_1, int int_1, int int_2, int int_3, double double_1, double double_2, double double_3, float float_1, double double_4, BitSet bitSet_1) {
   ...
   protected void carveTunnels(Chunk chunk_1, long long_1, int int_1, int int_2, int int_3, double double_1, double double_2, double double_3, float float_1, float float_2, float float_3, int int_4, int int_5, double double_4, BitSet bitSet_1) {
