...
public class CoralShelfFeature extends Feature<DefaultFeatureConfig> {
	private CoralShelfBlocksSimplifier blocksSimplifier;

	public CoralShelfFeature(CoralShelfBlocksSimplifier blocksSimplifier, Function<Dynamic<?>, ? extends DefaultFeatureConfig> config) {
		super(config);
